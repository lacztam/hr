...
public class EmployeeSpecification {
	...
	public static Specification<Employee> hasSalary(int salary) {
		return (root, cq, cb) -> cb.between(root.get(Employee_.monthlySalary), salaryMinus5Percentage(salary),
				salaryPlus5Percentage(salary));
	}
	...
	public static Specification<Employee> startDateLessThan(LocalDate start) {
		return (root, cq, cb) -> cb.lessThan(root.get(Employee_.beginningOfEmployment),
